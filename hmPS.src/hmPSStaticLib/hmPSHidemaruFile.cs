...
public sealed partial class hmPSDynamicLib
{
    public sealed partial class Hidemaru
    {
        ...
        public static TFile File;
        public sealed class TFile
        {
            public TFile()
            {
                SetUnManagedDll();
            ...
            public static IEncoding GetEncoding(string filepath)
            {
                ...
                IEncoding encoding = new Hidemaru.TFile.Encoding(hm_encode, ms_codepage);
                return encoding;
            }
            ...
            public class HidemaruStreamReader : IHidemaruStreamReader
            {
                ...
                public HidemaruStreamReader(String path, int hm_encode = -1)
                {
                    ...
                    int ms_codepage = GetMsCodePage(hm_encode);
                    this.m_encoding = new Hidemaru.TFile.Encoding(hm_encode, ms_codepage);
                }
                ...
                String TFile.IHidemaruStreamReader.Read()
                {
            ...
            public static IHidemaruStreamReader Open(string filepath, int hm_encode = -1)
            {
                ...
                IHidemaruStreamReader sr = new TFile.HidemaruStreamReader(filepath, hm_encode);
                return sr;
            }
